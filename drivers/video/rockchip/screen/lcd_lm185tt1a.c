...
#define DCLK	          77000000
#define LCDC_ACLK         300000000           //29 lcdc axi DMA ÆµÂÊ ,after rk30xx board it is set by system clock,it can't change by external driver
...
#define LCD_HEIGHT         	230
/* Other */
#ifdef CONFIG_RK610_LVDS
#define DCLK_POL	1
#else
//modified by tiny_pi for lvds
#define DCLK_POL	1
//modified by tiny_pi end
#endif
#define DEN_POL		0
#define VSYNC_POL	0
#define HSYNC_POL	0
